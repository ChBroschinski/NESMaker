...
;;; If it is a weapon, it will check against monsters only.
                        ...
                        +isNotPlayerPowerupCol  
                            ...
                            +isPlayerNPCCol
                                ...
                                BEQ +skipCollision
                                    TXA
                                    STA otherObject
                                    ;; There was a collision between a player and an NPC.
                                    ;; player is self.
                                    ;; NPC is other.
                                    ;;modified code; change action to stop from npc, assumes stop is action 1
        ...
        LDA Object_flags,x
        AND #%10000000
        BNE +isNPCForCollisions
            JMP +notNPCForCollisions
        +isNPCForCollisions
        LDX #$00
        loop_objectNPCCollisions:
            CPX selfObject
            BNE +notSelfObject
                JMP +skipCollision
            +notSelfObject
            ...
            +isActive
            LDA Object_flags,x
            AND #%10000000 ;;npc/npc collision
            BNE +isNPCNPCCol
                JMP +isNotNPCNPCCol
            +isNPCNPCCol
            JSR getOtherColBox
